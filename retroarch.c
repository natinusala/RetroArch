...
;
...
#endif
   {
      ...
      if ((!video_driver_has_widgets() || !menu_widgets_set_rewind(rewinding)) && rewinding)
         runloop_msg_queue_push(s, 0, t, true, NULL, MESSAGE_QUEUE_ICON_DEFAULT, MESSAGE_QUEUE_CATEGORY_INFO);
   }
